...
btn_clear =tk.Button(root, text="=", command=evaluate_calculation, width=11, font=("Arial", 14))
btn_clear.grid(row=6, column=3, columnspan=2)

btn_opening =tk.Button(root, text="(", command=lambda: add_to_calculation("("), width=5, font=("Arial", 14))
btn_opening.grid(row=2, column=1)

btn_closing =tk.Button(root, text=")", command=lambda: add_to_calculation(")"), width=5, font=("Arial", 14))
btn_closing.grid(row=2, column=2)
